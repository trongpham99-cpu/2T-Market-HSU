...
export class AdminComponent implements OnInit {
  ...
  constructor(private UsersService:UsersService, private ProfileService:ProfileService,private http: HttpClient,public ThongkeService:ThongkeService ) { }
  ...
  ngOnInit(): void {
    ...
    this.getSpDaBan();
    this.getSpDangBan();
    this.getSanPhamTrongThang();
  }
  public temp; conutTk=0;
  async getSanPhamTrongThang(){
    this.ThongkeService.getThongkeThang6().subscribe(data=>{
      this.temp = data;
      console.log(data);
